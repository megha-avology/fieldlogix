                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="left">
                            ...
                            <p class="typeJsText1 type-write" data-typetext="<?php echo $h_bnr_typ_txt; ?>">
                                <?php echo $h_bnr_typ_txt; ?>
                            </p>
                            <div class="banner-icon banner-icon1">
                                <?php
                            ...
                            <div class="banner-icon banner-icon2">
                            ...
                            <div class="banner-icon">
                                ...
                                if (have_rows('entr_p_fetr_pnts_rep')) {
                                    ...
                                    while (have_rows('entr_p_fetr_pnts_rep')) {
                                        ...
                                        $mobile_display = get_sub_field('entr_display_on_mobile');
                                ?>
                                        <?php $mobile_class = $mobile_display ? 'show-mobile' : 'hide-mobile'; ?>

                                        <div class="accordion-item <?php echo $mobile_class; ?>">
                    ...
                    <div class="col-sm-12">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Take a tour</button>
                            </div>
                        </nav>
