<?php
/* Template Name: equipment-tracking-page Template */
get_header();?>

<main id="main">
            <section class="hero real-ban" id="new-imp">
                ...
                <div class="container">
                   <div class="about-fleet">
                    ...
                    <div class="border">
                        ...
                        <?php
                            $link = get_field( 'last_btn' );
                            if ( $link ) :
                                $link_url = $link['url'];
                                $link_title = $link['title'];
                    			 $link_target = $link['target'] ? $link['target'] : '_self';
                                ?>
                                <a class="equip" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
                            <?php endif; ?>
