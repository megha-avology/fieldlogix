<?php
/* Template Name: reduce-excessive-idling-page Template */
get_header();?>

<main id="main">
            <section class="hero driver-safety-scoreCard" id="red-banner">
            ...
            <section class="fleets-section reduce-excessive-idling">
                <div class="container">
