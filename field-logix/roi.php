...
<main id="main">
            <section class="hero" id="roi-width">
    ...
    <section class="fleets-section" id="checklist">
                <div class="container">
					...
					<div id="roi-form" class="border-form gps-calculator-form">
						<div id="partner-form" class="about-fleet">
							<?php echo do_shortcode('[gravityform id="24" title="true" description="true" ajax="true"]');?>
						</div>
					</div>
                </div>
            </section>
