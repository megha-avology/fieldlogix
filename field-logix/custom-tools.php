<?php
/* Template Name: custom-tools Template */
get_header();?>
<style>
...
<main id="main">
            <section class="hero " id="partner-detail-hero">
                <div class="banner-content-sol">
                    <div class="container">
                        <div class="left-content-sol content_ttle">
      ...
      <?php if ( $all_banner_img1 = get_field( 'all_banner_img1' ) ) : ?>
            ...
            <section class="fleets-section " id="new-template-fleet">
                <div class="container">
					<?php if( have_rows('tools_main_repeater') ):  while ( have_rows('tools_main_repeater') ) : the_row(); ?>
                    <div class="about-fleet" id="first-fleet">
                        <h1><?php the_sub_field('tools_heading1'); ?></h1>
                        <div class="fleet-para">
                            
							<?php the_sub_field('tools_description1'); ?>
