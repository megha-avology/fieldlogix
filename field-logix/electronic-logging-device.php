<?php
/* Template Name: electronic-logging-device-page Template */
get_header();?>

<main id="main">
            <section class="hero electronicLoggingDevice" id="dash-camera">
                <div class="banner-content-sol">
                    ...
                    <div class="right-content">
                        <?php 
                            ...
                            ?>
                                <img src="<?php echo esc_url($all_banner_img1); ?>" alt="<?php echo esc_attr($desktop_alt); ?>" class="desktop-ban-img">
                            <?php endif; ?>
                            <?php 
                            ...
                            ?>
                                <img src="<?php echo esc_url($all_banner_img2); ?>" alt="<?php echo esc_attr($mobile_alt); ?>" class="mbl-ban-img">
                            <?php endif; ?>
                    </div>
                </div>
            </section>
            <section class="fleets-section vehicle-Inspection electronicLoggingDevice" id="dash-camera">
                <div class="container">
