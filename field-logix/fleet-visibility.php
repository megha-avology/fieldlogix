<?php
/* Template Name: fleet-visibility-page Template */
get_header();?>


<main id="main">
            <section class="hero vis-aft" id="new-imp">
            ...
            <section class="fleets-section" id="fleet-visibility">
                <div class="container">
                            ...
                            <div class="fleet-boxes">
                                ...
                                ?>
                                    <div class="single-fleet-box">
                                        ...
                                        <?php if ($icon_url): ?>
                                            <a class="cnt-immm" href="<?php echo esc_url($box_link); ?>" target="_blank" rel="noopener">
                                                <img src="<?php echo esc_url($icon_url); ?>" 
                                                    alt="<?php echo esc_attr($icon_alt); ?>">
                                            </a>
                                        <?php endif; ?>

                                        <?php if ($box_link && get_sub_field('box_title')): ?>
                                            <a href="<?php echo esc_url($box_link); ?>" target="_blank">
