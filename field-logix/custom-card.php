<?php
/* Template Name: custom-card Template */
get_header();?>
<style>
...
<main id="main">
      ...
      <?php if ( $all_banner_img1 = get_field( 'all_banner_img1' ) ) : ?>
            ...
            <section class="fleets-section " id="new-template-fleet">
                <div class="container">
					<?php if( have_rows('card_repeater1') ):  while ( have_rows('card_repeater1') ) : the_row(); ?>
                    <div class="about-fleet" id="first-fleet">
                        <h3><?php the_sub_field('card_heading'); ?></h3>
                        <div class="fleet-para">
                            
							<?php the_sub_field('card_description1'); ?>
	...
	<div class="presenter-head">
                        <h2><?php the_field('card_about_heading');?></h2>
                    </div>
	<div class="border">
							<div class="box-area">
								<div class="fleet-boxes" id="presenters-boxes">
									<?php if( have_rows('card_about_repeater') ):  while ( have_rows('card_about_repeater') ) : the_row(); ?>
									
						<div class="single-fleet-box">
											<img src="<?php the_sub_field('card_about_icon'); ?>" alt="fleet">
											<h3><?php the_sub_field('card_about_name'); ?></h3>
											<p><?php the_sub_field('card_about_tagline'); ?></p>
		</div>
									<?php endwhile; endif; ?>
		...
		<div class="about-fleet" id="system-about">
															<h3><?php the_field('about_fieldlogix_heading');?></h3>
														<div class="fleet-para">
											    <?php the_field('about_fieldlogix_data');?>
															</div>
						</div>
		</div>
	</section>
