...
// 	jQuery('.menu-item-has-children>a').append('<img src="https://fieldlogix.com/wp-content/uploads/2024/03/mbl-dropdown-header.svg" alt="" aria-hidden="true">');
//     jQuery(".mbl-dropdown > a img").click(function (e) {
//       e.preventDefault();
//       var jQuerymenu = jQuery(this).parent().siblings(".sub-menu");
//       jQuery(".sub-menu").not(jQuerymenu).slideUp(300);
...
if (jQuery(window).width() < 1280) {
  jQuery('.menu-item-has-children').addClass('mbl-dropdown');
  jQuery('.menu-item-has-children>a').append('<span class="dropdown-container"><img src="https://fieldlogix.com/wp-content/uploads/2024/03/mbl-dropdown-header.svg" alt="mbl-dropdown-header" ></span>');
}
