    ...
    <section class="detail-section" id="blog-detail">
        <div class="container">
            <div class="detail-banner">
                <a class="back" href="<?php echo esc_url(home_url()); ?>/news"><img
    ...
    <div class="blog-upper-box">
        <div class="blog-upper-left">
            ...
            <?php if ($img_src = find_img_src($post)) : 
                // Get featured image ALT from Media Library
                $thumb_id = get_post_thumbnail_id($post->ID);
                $alt = get_post_meta($thumb_id, '_wp_attachment_image_alt', true);

                // Fallback to post title if ALT empty
                if (empty($alt)) {
        ...
        <div class="blog-upper-right">
            <div class="blog-content">
                ...
                <h1 style="font-size:48px;"><?php the_title(); ?></h1>
...
<!--                         <div class="press-person">
                        ...
                        <div class="press-share">
                            ...
                            <div class="press-social">
								...
								<a href="#" onclick="shareOnLinkedin()">
									<div class="press-social-icon">
										<img src="<?php bloginfo('template_url');?>/images/linkedin-svg.svg" alt="linkedin">
									</div>
								</a>
                            </div>
							<script>
                ...
                <div class="press-user-details">
                    ...
                    <div class="detail-routes">
                        ...
                        the_post_navigation(
                            array(
                                'prev_text' => '<div class="router"><div class="prev-route"><img src="' . esc_url(get_bloginfo('template_url')) . '/images/back-arrow-long.svg" alt="#"></div><h6>%title</h6></div>',
                                'next_text' => '<div class="router"><h6>%title</h6><div class="prev-route"><img src="' . esc_url(get_bloginfo('template_url')) . '/images/next-arrow-long.svg" alt="#"></div></div>',
                            )
                        );
                        ?>
                    </div>
