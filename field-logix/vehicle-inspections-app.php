<?php
/* Template Name: vehicle-inspections-app-page Template */
get_header();?>

 <main id="main">
            <section class="hero vehicle-Inspection" id= "new-imp">
                <div class="banner-content-sol">
                   ...
                   <div class="right-content">
                    <?php 
                    $desktop_img_url = get_field('all_banner_img1');
                    if ($desktop_img_url) :
                    ...
                    <?php 
                    // Mobile banner
                    $mobile_img_url = get_field('all_banner_img2');
                    if ($mobile_img_url) :
            ...
            <section class="fleets-section vehicle-Inspection" id="dash-camera">
                <div class="container">
