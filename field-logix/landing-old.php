...
<!-- End Google Tag Manager -->
   ...
   <link rel="icon" type="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/image/png" href="img/favicon-1.png">
   <!-- Slick CSS -->
            ...
            <div class="inner-top-header">
               ...
               <div class="login">
                  <a href="https://secure.fieldlogixgps.com/" target="_blank">
                     <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/top-person.svg" alt="login">
                     <p>Login</p>
                  </a>
               </div>
            </div>
            ...
            <div class="innerHeader">
               ...
               <div class="get-started">
                        ...
                        <ul>
                           <li>
                              <a href="" target="_blank">
                                 <img
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/login-person.svg"
                                    alt="user">
                                 Login
                              </a>
                           </li>
                           <li>
                              <a href="tel:888-803-0200" target="_blank">
                                 <img width="20" height="20"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/volume.svg"
                                    alt="phone">
                                 888-803-0200
                              </a>
                           </li>
                  ...
                  <div class="head-button">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/search.svg" alt="search" class="search-toggle">
   ...
   <main>
            ...
            <div class="row">
               <div class="col-lg-5">
                  <div class="left">
                     ...
                     <a href="<?php echo $h_bnr_btn['url']; ?>" class="primary-btn"><?php echo $h_bnr_btn['title']; ?></a>
                  </div>
               </div>
               <div class="col-lg-7">
                  <div class="right">
      ...
      <section class="serving-slider" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1000">
         <div class="container">
            ...
            <div class="take-tour-btn">
               <?php $serv_s_btn = get_field('serv_s_btn'); ?>
               <a href="<?php echo $serv_s_btn['url']; ?>" class="primary-btn"><?php echo $serv_s_btn['title']; ?></a>
            </div>
         </div>
      </section>
      <!-- serving-slider end -->
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <a href="<?php echo $entr_p_btn['url']; ?>" class="primary-btn"><?php echo $entr_p_btn['title']; ?></a>
               </div>
            </div>
         </div>
      </section>
            ...
            <div thumbsSlider="" class="swiper mySwiper">
               <div class="swiper-wrapper">
                  <div class="swiper-slide">
                     <div class="all-users">
                        <div class="user-name">
                           <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/user1.webp" alt="user"></figure>
                           <div class="user-info">
                              <h6>Chris Miller</h6>
                              <p>Trane</p>
                           </div>
                  ...
                  <div class="swiper-slide">
                     <div class="all-users">
                        <div class="user-name">
                           <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/user2.webp" alt="user"></figure>
                           <div class="user-info">
                              <h6>Chris Miller</h6>
                              <p>Trane</p>
                           </div>
                  ...
                  <div class="swiper-slide">
                     <div class="all-users">
                        <div class="user-name">
                           <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/user3.webp" alt="user"></figure>
                           <div class="user-info">
                              <h6>Chris Miller</h6>
                              <p>Trane</p>
                           </div>
               ...
               <div class="swiper mySwiper2">
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="serving-img">
                           <div class="profiler">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/user1.webp" alt="user">
                           </div>
                           <ul>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                     ...
                     <div class="swiper-slide">
                        <div class="serving-img">
                           <div class="profiler">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/user2.webp" alt="user">
                           </div>
                           <ul>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                     ...
                     <div class="swiper-slide">
                        <div class="serving-img">
                           <div class="profiler">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/user3.webp" alt="user">
                           </div>
                           <ul>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
                              <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/full-rating.svg" alt="star"></li>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="slider-sec">
                     ...
                     <a href="<?php echo $srving_slider_2_btn['url']; ?>" class="primary-btn"><?php echo $srving_slider_2_btn['title']; ?></a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <!-- <section class="compaire" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
         <div class="compaire-layer">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/Maskgroup.png" alt="">
         </div>
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <table>
                     <thead>
                        <tr>
                           ...
                           <th class="fieldlogix-header"><img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/Logo-new.svg" alt=""></th>
            ...
            <div class="inner-footer">
               ...
               <div class="logo-links">
                  <div class="footer-logos">
                     <div class="main-logo">
                        <a href="#">
                           <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/foot-logo.svg" alt="FieldLogix"></noscript>
                        </a>
                     </div>
                     <div class="social-logos">
                        <div class="social">
                           <a href="#">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/facebook-white.svg">
                           </a>
                        </div>
                        <div class="social">
                           <a href="#">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/twitter.svg">
                           </a>
                        </div>
                        <div class="social">
                           <a href="#">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/instagram.svg">
                           </a>
                        </div>
                        <div class="social">
                           <a href="#">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/youtube.svg">
                           </a>
                        </div>
                        <div class="social">
                           <a href="#">
                              <img src="<?php echo get_stylesheet_directory_uri(); ?>/landing_assets/img/inkedin.svg">
                           </a>
                        </div>
                     </div>
                  </div>
