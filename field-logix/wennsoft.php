<?php
/* Template Name: wennsoft-page Template */
get_header();?>
                        ...
                        <div class="box-area">
                            <div class="fleet-boxes" id="partner-detail-boxes">
                                <div class="single-fleet-box">
                                    ...
                                    <img src="https://fieldlogix.com/wp-content/uploads/2024/10/pd-1-1-1.svg" alt="fleet">
                                    <h3>About FieldLogix</h3>
                                    <p>Since 2002, FieldLogix has been helping fleets throughout the world improve
                                        efficiency with our award-winning Field Resource Management platform that
                                        includes GPS Fleet Tracking, Fleet Dashcams, and Dispatch software.  Our
                                        integrations with some of the leading operational software providers helps
                                        organizations streamline their dispatching process.</p>

                                </div>
                                <div class="single-fleet-box">

                                    <img src="<?php bloginfo('template_url');?>/images/pd-2.svg" alt="fleet">
                                    <h3>About Wennsoft</h3>
                                    <p>Wennsoft provides field service, construction management and IoT asset
                                        intelligence solutions. We empower specialty trades businesses to deliver
                                        proactive service, increase profitability and improve building performance. We
                                        believe organizations that embrace the power of technology and data analytics
                                        will outpace their competition. To learn more, visit www.wennsoft.com.
                                    </p>
