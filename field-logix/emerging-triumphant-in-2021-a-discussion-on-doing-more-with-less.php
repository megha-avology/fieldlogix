<?php
/* Template Name: emerging-triumphant-in-2021-a-discussion-on-doing-more-with-less-page Template */
get_header();?>
...
<main id="main">
    ...
    <section class="fleets-section" id="checklist">
                <div class="container">
					...
					<?php if ( $description_heading = get_field( 'description_heading_second' ) ) : ?>
						<div class="about-fleet" id="system-about">
							<?php if ( $description_heading = get_field( 'description_heading_second' ) ) : ?>
								<h3><?php echo esc_html( $description_heading ); ?></h3>
							<?php endif; ?>
							<div class="fleet-para">
								<?php if ( $description_content = get_field( 'description_content_second' ) ) : ?>
									<?php echo $description_content; ?>
								<?php endif; ?>
								<?php
									$description_image = get_field( 'description_image_second' );
									if ( $description_image ) : ?>
										<img src="<?php echo esc_url( $description_image['url'] ); ?>" alt="<?php echo esc_attr( $description_image['alt'] ); ?>" />
								<?php endif; ?>
							</div>
