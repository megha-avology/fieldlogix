			...
			<div id="page-content">
				...
				<div id="inner-content" class="wrap clearfix">
					...
					<div id="main" class="twelvecol first clearfix case-study-content" role="main">
						...
						<?php if ( !is_paged() ) { // if this is the first page of a paginated archive, pull in the content from page ID# 34522 ?>
							<div class="intro-content">
								<?php
								$my_postid = 34522;// This is page id of "Case Studies Intro Content"
